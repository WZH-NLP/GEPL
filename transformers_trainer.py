...
def parse_arguments(parser):
    ...
    """
    parser.add_argument('--device', type=str, default="cuda", choices=['cpu', 'cuda:0', 'cuda:1', 'cuda:2','cuda'],
...
def main():
    ...
    if opt.mode == "train":
        ...
        print(conf.parallel_embedder)
        bert_base_cased_path = './pretrained/bert-base-cased'
        # tokenizer = context_models[conf.embedder_type]["tokenizer"].from_pretrained(self.embedder_type)
